...
<div class="container">
  <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white border rounded-lg p-8">
    <div class="lg:col-span-5">
      <main id="gallery">
        <div id="main-image">
          <img src="/assets/img/roma-wafello-chocoblast-depan.jpg" alt="Image" class="object-contain max-w-full h-[314px] mt-2 p-1 bg-gray-50 border border-gray-300 rounded-md">
        </div>
        <div id="images" class="grid grid-cols-4 gap-x-4 mt-3">
          <img src="/assets/img/roma-wafello-chocoblast-depan.jpg" alt="Image" class="max-w-full h-auto mt-2 p-1 bg-gray-50 border border-gray-300 rounded-md">
          <img src="/assets/img/roma-wafello-chocoblast-belakang.jpg" alt="Image" class="max-w-full h-auto mt-2 p-1 bg-white border border-gray-300 rounded-md">
        </div>
        <script>
